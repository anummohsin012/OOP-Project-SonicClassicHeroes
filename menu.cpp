...
//
//public:
//	Menu(int height, int width) : optionsopen(false), index(0), volumelevel(0), activenamein(false) {
...
//		nametext.setPosition(width / 2 - 150, height / 2);
//
...
//			enteredname.setCharacterSize(30);
//			enteredname.setFillColor(Color::Cyan);
//			enteredname.setString(plname);
//			enteredname.setPosition(width / 2 - 50 + 100, height / 2);
//
...
//	}
//
//	void namehandeling(Event nameadd) {
//		if (activenamein && nameadd.type == Event::TextEntered) {
//
//
//		}
//
